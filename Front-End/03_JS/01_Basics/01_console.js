/*
    JS is a scripting language. Can be used for both server side and client side.
    Now I have saved the file as 01.js where 01 is the name of file and js is its extension. Entension describes the type of file which in this case is JavaScript file.
...
// console.assert()  Asserts a condition, and logs a message to the console if it's false
